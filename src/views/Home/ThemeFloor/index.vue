                    ...
                    <div class="floor-1">
                        ...
                        <div class="split">
                            ...
                            <div
                                ...
                                v-for="(recommend_img_url, index) in floor.recommendList.slice(0,2)"
                                :key="index"
                            >
                                <img :src="recommend_img_url" />
                            </div>
                        </div>
                        ...
                        <div class="split">
                            ...
                            <div
                                class="floor-conver-pit"
                                v-for="(recommend_img_url, index) in floor.recommendList.slice(2)"
                                :key="index"
                            >
                                <img :src="recommend_img_url" />
                            </div>
